...
export function TitleScreen({
  ...
  return (
    ...
    >
      ...
      {/* ── Scrollable middle: song list + trending ───────────────── */}
      ...
      <div className="relative shrink-0 flex flex-col items-center gap-5 px-6 pb-10 pt-5">
        <motion.button
          ...
          className="rounded-full border border-white/40 bg-white/10 px-12 py-4 text-sm uppercase tracking-[0.4em] text-white backdrop-blur-md transition-all duration-500 hover:border-white/80 hover:bg-white/20"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
